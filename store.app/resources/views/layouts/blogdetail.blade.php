                ...
                <div class="single-post row">
                    <div class="col-lg-12">
                        <div class="feature-img">
                            <img class="img-fluid" src="{{ asset ('homeassets/img/blog/feature-img1.jpg ') }}" alt="">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <img class="img-fluid" src="{{ asset ('homeassets/img/blog/post-img1.jpg ') }}" alt="">
                            </div>
                            <div class="col-6">
                                <img class="img-fluid" src="{{ asset ('homeassets/img/blog/post-img2.jpg ') }}" alt="">
                            </div>
                ...
                <div class="navigation-area">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
                            <div class="thumb">
                                <a href="#"><img class="img-fluid" src="{{ asset ('homeassets/img/blog/prev.jpg ') }}" alt=""></a>
                            </div>
                            <div class="arrow">
                        ...
                        <div class="col-lg-6 col-md-6 col-12 nav-right flex-row d-flex justify-content-end align-items-center">
                            ...
                            <div class="thumb">
                                <a href="#"><img class="img-fluid" src="{{ asset ('homeassets/img/blog/next.jpg ') }}" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="comments-area">
                    ...
                    <div class="comment-list">
                        <div class="single-comment justify-content-between d-flex">
                            <div class="user justify-content-between d-flex">
                                <div class="thumb">
                                    <img src="{{ asset ('homeassets/img/blog/c1.jpg ') }}" alt="">
                                </div>
                                <div class="desc">
                    ...
                    <div class="comment-list left-padding">
                        <div class="single-comment justify-content-between d-flex">
                            <div class="user justify-content-between d-flex">
                                <div class="thumb">
                                    <img src="{{ asset ('homeassets/img/blog/c2.jpg ') }}" alt="">
                                </div>
                                <div class="desc">
                    ...
                    <div class="comment-list left-padding">
                        <div class="single-comment justify-content-between d-flex">
                            <div class="user justify-content-between d-flex">
                                <div class="thumb">
                                    <img src="{{ asset ('homeassets/img/blog/c3.jpg ') }}" alt="">
                                </div>
                                <div class="desc">
                    ...
                    <div class="comment-list">
                        <div class="single-comment justify-content-between d-flex">
                            <div class="user justify-content-between d-flex">
                                <div class="thumb">
                                    <img src="{{ asset ('homeassets/img/blog/c4.jpg ') }}" alt="">
                                </div>
                                <div class="desc">
                    ...
                    <div class="comment-list">
                        <div class="single-comment justify-content-between d-flex">
                            <div class="user justify-content-between d-flex">
                                <div class="thumb">
                                    <img src="{{ asset ('homeassets/img/blog/c5.jpg ') }}" alt="">
                                </div>
                                <div class="desc">
            ...
            <div class="col-lg-4">
                <div class="blog_right_sidebar">
                    ...
                    <aside class="single_sidebar_widget author_widget">
                        <img class="author_img rounded-circle" src="{{ asset ('homeassets/img/blog/author.png') }}" alt="">
                    ...
                    <aside class="single_sidebar_widget popular_post_widget">
                        ...
                        <div class="media post_item">
                            <img src="{{ asset ('homeassets/img/blog/popular-post/post1.jpg ') }}" alt="post">
                        ...
                        <div class="media post_item">
                            <img src="{{ asset ('homeassets/img/blog/popular-post/post2.jpg ') }}" alt="post">
                            <div class="media-body">
                                <a href="blog-details.html">
                        ...
                        <div class="media post_item">
                            <img src="{{ asset ('homeassets/img/blog/popular-post/post3.jpg ') }}" alt="post">
                            <div class="media-body">
                                <a href="blog-details.html">
                        ...
                        <div class="media post_item">
                            <img src="{{ asset ('homeassets/img/blog/popular-post/post4.jpg ') }}" alt="post">
                            <div class="media-body">
                                <a href="blog-details.html">
                    ...
                    <aside class="single_sidebar_widget ads_widget">
                        <a href="#"><img class="img-fluid" src="{{ asset ('homeassets/img/blog/add.jpg ') }}" alt=""></a>
                        <div class="br"></div>
                    </aside>
