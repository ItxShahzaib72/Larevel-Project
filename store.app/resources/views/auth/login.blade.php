			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form method="POST" action="{{ route('login') }}" class="row login_form" id="contactForm" novalidate="novalidate">
                            @csrf
							...
							<div class="col-md-12 form-group">
								<button action="('{{ __('Log in') }}')" type="submit" value="submit" class="primary-btn">Log In</button>
								@if (Route::has('password.request'))
